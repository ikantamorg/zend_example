...
class User_Form_Signup_Buyer extends Zend_Form
{
    ...
    const ERROR_USER_EXISTS = 'This email is already taken.';

    public function init()
    {
        $this->setMethod('post')
                ->setDecorators(array(array('ViewScript', array('viewScript' => 'signup/buyer/form.phtml'))
        ));

        $this->addElement($this->_getFirstNameElement())
